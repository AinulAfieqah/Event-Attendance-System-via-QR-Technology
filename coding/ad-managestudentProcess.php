...
$query = "SELECT COUNT(*) as num FROM heasuratimran.students s";
$total_pages = mysqli_fetch_array(mysqli_query($db_connect, $query));
$total_pages = $total_pages["num"];			//$total_pages = $total_pages[num];//
$targetpage = "ad-managestudent.php"; 					//your file name  (the name of this file)//
...
$sql = "SELECT * FROM heasuratimran.students s JOIN heasuratimran.programmes p ON s.programmeid = p.programmeid LIMIT $start, $limit";
