<?php
include_once("ad-addadminProcess.php")
?>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Manage Admin &nbsp;<i class="glyphicon glyphicon-arrow-right"></i> &nbsp;Add Admin </h1>
                    </div>
            </div>
			<div class="row">
					...
					<div class="col-md-8"> 
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="text-align: center">
								<b><i class="glyphicon glyphicon-plus"></i> Add Admin</b> <!--Retrieve from database-->
							</div>
							<div class="panel-body">
								<form class="form-horizontal" method="post" name="form1">
									
									<div class="row form-group">
										<label class="col-md-4" align="right" for="ad_name">Admin Name</label>
										<div class="col-md-6">
											<input type="text" class="form-control" style="text-transform:uppercase" id="ad_name" placeholder="Enter name: Abu" name="ad_name"> 
										</div>
									</div>
									<div class="row form-group">
									...
									<div class="row">
										...
										<div class="col-md-2" align="left">
                                            <form class="form-horizontal" action="ad-dashboard.php" method="get" name="form2">
