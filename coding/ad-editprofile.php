<?php
include_once("ad-editprofileProcess.php")
?>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Manage Admin &nbsp;<i class="glyphicon glyphicon-arrow-right"></i> &nbsp; Edit Admin </h1>
                    </div>
            </div>
			<div class="row">
					...
					<div class="col-md-8"> 
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="text-align: center">
								<b><i class="glyphicon glyphicon-pencil"></i> Edit Admin</b> <!--Retrieve from database-->
							</div>
							<div class="panel-body">
								<form class="form-horizontal" method="post" name="form2">
									<div class=" row form-group">
										<label class="col-md-4" align="right">Admin ID</label>
										<div class="col-md-6">
											<input type="text" class="form-control" value="<?php echo $adminID;?>" name="adID" readonly /> <!--from database-->
										</div>
									</div>
									<div class="row form-group">
										<label class="col-md-4" align="right">Admin Name</label>
										<div class="col-md-6">
											<input type="text" class="form-control" style="text-transform:uppercase" value="<?php echo $adName;?>" name="adName"> <!--from database-->
										</div>
									</div>
                                    <div class="row form-group">
                                        <label class="col-md-4" align="right">Telephone No</label> 
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" value="<?php echo $adPhone;?>" name="adPhone">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <label class="col-md-4" align="right">Email</label>
                                        <div class="col-md-6">
                                            <input type="email" class="form-control" value="<?php echo $adEmail;?>" name="adEmail">
                                        </div>
                                    </div>
									<div class="row" align="center">
										<!--div class="col-md-10"></div>
										<div class="col-md-2" align="center"-->
                                            <form class="form-horizontal" action="ad-dashboard.php" method="get" name="mngO" >
											<!--input type="hidden" name="organizerID" value="<?php //echo $_GET['organizerID'];?>">-->
											<button type="submit" class="btn btn-success" name="update">UPDATE</button>
                                            <a href="ad-dashboard.php" class="btn btn-danger "> CANCEL</a>
